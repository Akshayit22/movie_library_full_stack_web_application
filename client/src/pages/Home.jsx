...
const Home = () => {
	...
	const [searchFilter, setSearchFilter] = useState('india');
		...
		<div className='min-h-screen mt-10'>
			{
				...
				loading ? <Spinner></Spinner>
					...
					<div>
						...
						<button onClick={() => moreHandler()} className='px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg justify-center'>more</button>
